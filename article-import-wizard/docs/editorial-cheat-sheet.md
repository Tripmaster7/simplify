...
Heading rule:
- H1 and H2 are reserved for article title and subtitle only.
- Use only [HEADER 3 ...] and [HEADER 4 ...] in the article body.
...
[HEADER 3 Background]
Body paragraph for section level 3.

[HEADER 4 Detail]
Body paragraph for section level 4.
